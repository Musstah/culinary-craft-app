  ...
  return (
    <>
      <div className="flex flex-col items-center">
        <header>
          <p className="my-12 text-4xl font-bold md:my-6 text-stone-600 dark:text-stone-300 md:mt-20">
            Register
          </p>
        </header>
        <main>
          ...
          {/* Horizontal Line */}
          <div className="w-11/12 mx-auto mt-12 border-b opacity-50 border-zinc-400 md:mt-20"></div>
          <p className="mt-6 mb-2 font-thin text-center text-stone-600 dark:text-stone-300">
            or sign up with
          </p>
          <div className="flex flex-col items-center mx-6 mt-4 space-x-0 space-y-6">
            <button
