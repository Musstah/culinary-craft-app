...
function Recipies() {
  ...
  return isLoading ? (
    ...
    <>
      ...
      <div className="flex flex-row flex-wrap self-end justify-start bg-slate-200 bg-opacity-50 md:bg-transparent p-2 mb-4 md:mt-4 text-gray-900 overflow-y-auto max-h-[600px] md:max-h-[800px]">
        {data.count > 0 ? (
